...
<html class="fixed">
	...
	<body>
		...
		<section class="body-sign">
			<div class="center-sign">
				<a href="/" class="logo pull-left">
					<img src="{{ url('assets/backend/assets/images/logo.png') }}" height="54" alt="Porto Admin" />
				</a>
						...
						<form action="index.html" method="post">
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input type="text" id="username" name="username" class="form-control input-lg" value="{{ old('username') }}" />
		...
		<script src="{{ url('assets/backend/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js') }}"></script>
		...
		<!-- Theme Custom -->
		<script src="{{ url('assets/backend/assets/javascripts/theme.custom.js') }}"></script>
